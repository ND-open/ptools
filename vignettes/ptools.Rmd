...
This packages provides basic R and Hadoop wrapper function to handle file movement in pipelines.
...
# full_trains # dim 5k * 27 
# small_trains # dim 32k * 13

# saveRDS(full_trains, "full_trains.rds") # saved with vignette
full_trains <- readRDS("full_trains.rds")
full_trains
```
